...
public class MultiSignByteBuffer {
    ...
    public MultiSignByteBuffer clear() {
        buf.clear();
        return this;
    }
    ...
    public MultiSignByteBuffer get(byte[] dst) {
        buf.get(dst);
        return this;
    }

    public MultiSignByteBuffer get(byte[] dst, int offset, int length) {
        buf.get(dst, offset, length);
        return this;
    }

    public MultiSignByteBuffer put(byte[] dst) {
        buf.put(dst);
        return this;
    }

    public MultiSignByteBuffer put(byte[] src, int offset, int length) {
